...
from master_command import master_kill_gunicorn_debug, master_start_gunicorn_debug

file_hashes = {}

setup_logging("gemgem-ai-master.log", "error-master.log")
