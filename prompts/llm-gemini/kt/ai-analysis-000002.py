...
- If a line appears **frequently across documents** as a structural label, treat it as a `"title-main"` **only when followed by distinct, structured content** and not as a `"text-main"` of an unrelated subtopic.
...
- `"sections"`: Subtopics related to the main topic, each with:
  ...
  -- `"text-extra"`: The **full body content** related to the section with preserved original structure. This includes descriptions, details, data, and anything associated with the section.
