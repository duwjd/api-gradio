...
## **TAG GUIDELINES**
    ...
    - **`title-main`**: The main title.
    - **`title-extra`**: Subtitle.
    - **`text-main`**: Concise statement of the main point.
    - **`text-extra`**: Additional supporting details. The number of details must match provided template JSON.
