from sqlalchemy import Column, Double, Integer, SmallInteger, String, Text, text, UniqueConstraint
from sqlalchemy.dialects.mysql import MEDIUMTEXT

from database.mariadb.models import Base, TimestampModel


class TaskGradio(Base, TimestampModel):
    __tablename__ = "task_gradio"
