...
import gradio as gr
from api.modules_gradio.config.constants import (
    VIDEO_MODELS,
...
def create_video_generation_model_dropdown():
    """비디오 생성 모델 선택 드롭다운"""
    return gr.Dropdown(
        choices=[API_VIDEO_MODEL.HAILUO_02, API_VIDEO_MODEL.KLING_V2_1, API_VIDEO_MODEL.SEEDANCE_1_LITE, API_VIDEO_MODEL.SEEDANCE_1_PRO], 
        label="영상 생성 모델 선택",
        interactive=True,
        visible=False,
        elem_id="video_generation_model"
    )